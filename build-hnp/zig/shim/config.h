/*
 * Zig CLI shim configuration
 */

#ifndef SHIM_CONFIG_H
#define SHIM_CONFIG_H

#define TARGET_COMMAND_PATH "/data/service/hnp/horpkg-base.org/horpkg-base_1.0/opt/zig/zig"
...
#define SHIM_ENV_VARS \
    X("ZIG_GLOBAL_CACHE_DIR", "/data/storage/el2/base/cache/zig") \
